...
export default function Footer() {
  ...
  return (
    <footer className="bg-gray-900 dark:bg-black text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-2">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h3 className="text-2xl font-bold text-gradient mb-4">Lewis Mwaura</h3>
              <p className="text-gray-300 mb-6 max-w-md">
                A passionate software developer and computer trainer dedicated to creating innovative 
          ...
          >
            ...
            <ul className="space-y-2">
              {['Home', 'About', 'Skills', 'Experience', 'Projects', 'Services', 'Contact'].map((link) => (
                <li key={link}>
                  <a
        ...
        >
          <div className="text-gray-400 text-sm mb-4 md:mb-0">
            © {currentYear} Lewis Mwaura Kinyanjui. All rights reserved.
          </div>
          
          <div className="flex items-center space-x-4">
            <span className="text-gray-400 text-sm">Made with</span>
            <Heart className="w-4 h-4 text-red-500 animate-pulse" />
            <span className="text-gray-400 text-sm">in Kenya</span>
          </div>
        </motion.div>
      </div>
      ...
      <motion.button
        onClick={scrollToTop}
        className="fixed bottom-8 right-8 w-12 h-12 bg-primary-600 hover:bg-primary-700 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 z-50"
        whileHover={{ scale: 1.1, y: -2 }}
        whileTap={{ scale: 0.9 }}
